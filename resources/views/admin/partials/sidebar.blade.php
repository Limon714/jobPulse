            ...
            <aside>
              <div class="left-sidebar" id="wrapper-sidebar">
                <ul>
                  ...
                  <li><a  class="{{ request()->routeIs('adminEmployers') || request()->routeIs('adminEditEmp') ? 'active' : '' }}" href="{{ url('/dashboard/employers') }}"><i class="material-icons">supervisor_account</i>Companies</a></li>
                  <li><a  class="{{request()->routeIs('adminCanTrash') || request()->routeIs('adminEditCan') || request()->routeIs('adminCandidates') ? 'active' : '' }}" href="{{ url('/dashboard/candidates') }}"><i class="material-icons">person</i> Employees</a></li>
                  ...
                  <li><a href="#"><i class="material-icons">collections</i>Blog</a></li>
                  <li><a href="#"><i class="material-icons">collections</i>Pages <i class="material-icons"> down-arrow </i></a>
                  ...
                  <li><a href="#"><i class="material-icons">collections</i>Plugins</a></li>
                  ...
                  <li><a class="{{  request()->routeIs('dashboard.settings')   ? 'active' : '' }}" href="{{ route('dashboard.settings') }}"><i class="material-icons">settings</i>Account Settings</a></li>
                  </ul>
              </div>  
            </aside>
        </div>
